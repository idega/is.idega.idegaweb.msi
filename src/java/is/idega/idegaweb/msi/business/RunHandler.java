...
public class RunHandler implements ICPropertyHandler {
	...
	public PresentationObject getHandlerObject(String name, String stringValue, IWContext iwc) {
		IWResourceBundle iwrb = iwc.getIWMainApplication().getBundle(MSIConstants.IW_BUNDLE_IDENTIFIER).getResourceBundle(iwc.getCurrentLocale());
		DropdownMenu menu = new DropdownMenu(MSIConstants.GROUP_TYPE_RACE);
		
		try {
			RaceBusiness business = (RaceBusiness) IBOLookup.getServiceInstance(iwc, RaceBusiness.class);
	...
	public PresentationObject getHandlerObject(String arg0, String arg1,
			IWContext arg2, boolean arg3, String arg4, String arg5) {
