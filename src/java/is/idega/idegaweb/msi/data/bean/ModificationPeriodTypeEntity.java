/**
 * @(#)ModificationPeriodTypeEntity.java    1.0.0 09:34:47
 *
...
/**
 * <p>Modification period classification</p>
 ...
 */
@Table(name = ModificationPeriodTypeEntity.TABLE_NAME)
@Entity
@NamedQueries({
	@NamedQuery(
			name = ModificationPeriodTypeEntity.FIND_BY_ID,
			query = "FROM ModificationPeriodTypeEntity s " +
					"WHERE s.id = :" + ModificationPeriodTypeEntity.ID_PROP),
	@NamedQuery(
			name = ModificationPeriodTypeEntity.FIND_BY_NAME,
			query = "FROM ModificationPeriodTypeEntity s " +
...
@Cacheable
public class ModificationPeriodTypeEntity implements Serializable {

	private static final long serialVersionUID = 6785676943428920745L;
