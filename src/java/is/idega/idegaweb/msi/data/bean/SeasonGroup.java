 ...
 */
@Entity
@DiscriminatorValue(MSIConstants.GROUP_TYPE_SEASON)
public class SeasonGroup extends Group {
	private static final long serialVersionUID = 7936789641064296147L;
}