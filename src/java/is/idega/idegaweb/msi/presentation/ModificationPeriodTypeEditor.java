/**
 * @(#)ModificationPeriodTypeEditor.java    1.0.0 12:57:42
 *
...
/**
 * <p>JSF UI component for editing {@link ModificationPeriodTypeEntity}</p>
 ...
 */
public class ModificationPeriodTypeEditor extends IWBaseComponent {

	public static final String FACELET_FILENAME = "modification_period_type_editor.xhtml";
	...
	protected void initializeComponent(FacesContext context) {
		...
		if (facelet instanceof FaceletComponent) {
			((FaceletComponent) facelet).setFaceletURI(getBundle(
					context, MSIConstants.IW_BUNDLE_IDENTIFIER
