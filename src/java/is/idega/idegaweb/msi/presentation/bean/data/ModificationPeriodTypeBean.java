/**
 * @(#)ModificationPeriodTypeBean.java    1.0.0 15:17:32
 *
...
/**
 * <p>JSF managed bean for editing {@link ModificationPeriodTypeEntity}</p>
 ...
 */
public class ModificationPeriodTypeBean extends
		ManagedBean<ModificationPeriodTypeEntity> {

	private static final long serialVersionUID = -365022712083778200L;
	...
	@Override
	public ModificationPeriodTypeDAO getDAO() {
	...
	public ModificationPeriodTypeBean() {}

	public ModificationPeriodTypeBean(ModificationPeriodTypeEntity entity) {
		setEntity(entity);
	}
