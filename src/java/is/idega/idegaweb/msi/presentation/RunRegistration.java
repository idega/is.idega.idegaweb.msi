...
public class RunRegistration extends Block {
	...
	private void initializeTexts(IWContext iwc) {
		...
		this.infoRedStarText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_INFO_RED_STAR, "These fields must be filled out"));
		//step one texts begin
		this.distanceText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_PRIMARY_DD, "Run") + "/" + this.iwrb.getLocalizedString(MSIConstants.RR_SECONDARY_DD, "Distance"));
		this.nameText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_NAME, "Name "));
		this.nationalityText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_NATIONALITY, "Nationality "));
		this.ssnText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_SSN, "SSN "));
		this.genderText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_GENDER, "Gender "));
		this.addressText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_ADDRESS, "Address"));
		this.postalText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_POSTAL, "Postal Code"));
		this.cityText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_CITY, "City"));
		this.countryText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_COUNTRY, "Country"));
		this.telText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_TEL, "Telephone"));
		this.mobileText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_MOBILE, "Mobile Phone"));
		this.emailText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_EMAIL, "Email "));
		this.tShirtText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_TSHIRT, "T-Shirt"));
		//step one texts end

		//step two texts begin
		this.chipText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_CHIP_TIME, "Championchip timing: "));
		this.ownChipText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_OWN_CHIP, "Own Chip"));
		this.buyChipText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_BUY_CHIP, "Buy Chip"));
		this.rentChipText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_RENT_CHIP, "Rent Chip"));
		this.groupCompetitionText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_GROUP_COMP, "Group competition"));
		this.groupNameText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_GROUP_NAME, "Group Name"));
		this.bestTimeText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_BEST_TIME, "Your best time running this distance"));
		this.goalTimeText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_GOAL_TIME, "Your goal in running this distance now"));
		this.agreementText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_AGREEMENT, "Agreement"));
		this.agreeText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_AGREE, "I agree"));
		this.disagreeText = new Text(this.iwrb.getLocalizedString(MSIConstants.RR_DISAGREE, "I disagree"));
		//step two texts end
	}
	...
	private void initializeFields(IWContext iwc) throws RemoteException {
		...
		this.runDropdown = new DropdownMenu(MSIConstants.GROUP_TYPE_RACE);
    ...
    this.distanceDropdown = new DropdownMenu(MSIConstants.GROUP_TYPE_RACE_EVENT);
		if(MSIConstants.GROUP_TYPE_RACE != null) {
			String runIdString = iwc.getParameter(MSIConstants.GROUP_TYPE_RACE);
			this.runDropdown.setSelectedElement(runIdString);
			if(runs != null) {
				if(runIdString != null && runIdString != "") {
					Group run = runBiz.getSeasonByGroupId(Integer.valueOf(runIdString));
					if(run != null) {
		...
		this.nameField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_NAME), STYLENAME_INTERFACE);
		...
		Collection countries = getRaceBiz(iwc).getCountries();

		this.nationalityField = (DropdownMenu) getStyleObject(new DropdownMenu(MSIConstants.PARAMETER_NATIONALITY), STYLENAME_INTERFACE);
		this.countryField = (DropdownMenu) getStyleObject(new DropdownMenu(MSIConstants.PARAMETER_COUNTRY), STYLENAME_INTERFACE);
		...
		this.ssnISField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_SSN_IS), STYLENAME_INTERFACE);
		...
		this.ssnField = (DateInput) getStyleObject(new DateInput(MSIConstants.PARAMETER_SSN), STYLENAME_INTERFACE);
		...
		this.genderField = (DropdownMenu) getStyleObject(new DropdownMenu(MSIConstants.PARAMETER_GENDER), STYLENAME_INTERFACE);
		this.genderField.addMenuElement(MSIConstants.PARAMETER_FEMALE, this.iwrb.getLocalizedString(MSIConstants.RR_FEMALE, "Female"));
		this.genderField.addMenuElement(MSIConstants.PARAMETER_MALE, this.iwrb.getLocalizedString(MSIConstants.RR_MALE, "Male"));

		this.addressField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_ADDRESS), STYLENAME_INTERFACE);
		...
		this.postalField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_POSTAL), STYLENAME_INTERFACE);
		...
		this.cityField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_CITY), STYLENAME_INTERFACE);
		...
		this.telField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_TEL), STYLENAME_INTERFACE);
		...
		this.mobileField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_MOBILE), STYLENAME_INTERFACE);
		...
		this.emailField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_EMAIL), STYLENAME_INTERFACE);
		...
		this.tShirtField = (DropdownMenu) getStyleObject(new DropdownMenu(MSIConstants.PARAMETER_TSHIRT), STYLENAME_INTERFACE);
		...
		this.small = new SelectOption("- " + this.iwrb.getLocalizedString("run_reg.small", "Small"), MSIConstants.PARAMETER_TSHIRT_S);
		this.medium = new SelectOption("- " + this.iwrb.getLocalizedString("run_reg.medium", "Medium"), MSIConstants.PARAMETER_TSHIRT_M);
		this.large = new SelectOption("- " + this.iwrb.getLocalizedString("run_reg.large", "Large"), MSIConstants.PARAMETER_TSHIRT_L);
		this.xlarge = new SelectOption("- " + this.iwrb.getLocalizedString("run_reg.xlarge", "Larger"), MSIConstants.PARAMETER_TSHIRT_XL);
		this.xxlarge = new SelectOption("- " + this.iwrb.getLocalizedString("run_reg.xxlarge", "Largest"), MSIConstants.PARAMETER_TSHIRT_XXL);
		...
		SelectOption smallKids = new SelectOption("- " + this.iwrb.getLocalizedString("run_reg.small_kids", "Small"), MSIConstants.PARAMETER_TSHIRT_S + "_kids");
		SelectOption mediumKids = new SelectOption("- " + this.iwrb.getLocalizedString("run_reg.medium_kids", "Medium"), MSIConstants.PARAMETER_TSHIRT_M + "_kids");
		SelectOption largeKids = new SelectOption("- " + this.iwrb.getLocalizedString("run_reg.large_kids", "Large"), MSIConstants.PARAMETER_TSHIRT_L + "_kids");
		SelectOption xlargeKids = new SelectOption("- " + this.iwrb.getLocalizedString("run_reg.xlarge_kids", "Larger"), MSIConstants.PARAMETER_TSHIRT_XL + "_kids");
		...
		this.ownChipField = (RadioButton) getStyleObject(new RadioButton(MSIConstants.PARAMETER_CHIP, MSIConstants.PARAMETER_OWN_CHIP), STYLENAME_CHECKBOX);
		...
		this.buyChipField = (RadioButton) getStyleObject(new RadioButton(MSIConstants.PARAMETER_CHIP, MSIConstants.PARAMETER_BUY_CHIP), STYLENAME_CHECKBOX);

		this.rentChipField = (RadioButton) getStyleObject(new RadioButton(MSIConstants.PARAMETER_CHIP, MSIConstants.PARAMETER_RENT_CHIP), STYLENAME_CHECKBOX);

		this.chipNumberField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_CHIP_NUMBER), STYLENAME_INTERFACE);

		this.groupCompetitionField = (CheckBox) getStyleObject(new CheckBox(MSIConstants.PARAMETER_GROUP_COMP), STYLENAME_CHECKBOX);

		this.groupNameField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_GROUP_NAME), STYLENAME_INTERFACE);
		this.groupNameField.setWidth("50%");

		this.bestTimeField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_BEST_TIME), STYLENAME_INTERFACE);
		this.bestTimeField.setWidth("50%");

		this.goalTimeField = (TextInput) getStyleObject(new TextInput(MSIConstants.PARAMETER_GOAL_TIME), STYLENAME_INTERFACE);
		this.goalTimeField.setWidth("50%");
		
		this.agreeField = (RadioButton) getStyleObject(new RadioButton(MSIConstants.PARAMETER_AGREEMENT, MSIConstants.PARAMETER_AGREE), STYLENAME_CHECKBOX);
		
		this.disagreeField = (RadioButton) getStyleObject(new RadioButton(MSIConstants.PARAMETER_AGREEMENT, MSIConstants.PARAMETER_DISAGREE), STYLENAME_CHECKBOX);
	...
	private void stepOne(IWContext iwc, Form f) {
		...
		emailValidation.append("var email = findObj('"+MSIConstants.PARAMETER_EMAIL+"');").append("\n\t");
	...
	private void stepTwo(IWContext iwc, Form f) {
		...
		int distanceID = Integer.parseInt(iwc.getParameter(MSIConstants.GROUP_TYPE_RACE_EVENT));
	...
	private void commitRegistration(IWContext iwc, Form f) throws RemoteException {
		...
		//user info
		String name = iwc.getParameter(MSIConstants.PARAMETER_NAME);
		String nationality = iwc.getParameter(MSIConstants.PARAMETER_NATIONALITY);
		String ssnIS = iwc.getParameter(MSIConstants.PARAMETER_SSN_IS);
		String ssn = iwc.getParameter(MSIConstants.PARAMETER_SSN);
		...
		//run info
		String run = iwc.getParameter(MSIConstants.GROUP_TYPE_RACE);
		String distance = iwc.getParameter(MSIConstants.GROUP_TYPE_RACE_EVENT);
		IWTimestamp now = IWTimestamp.RightNow();
		Integer y = new Integer(now.getYear());
		String year = y.toString();

		String tshirt = iwc.getParameter(MSIConstants.PARAMETER_TSHIRT);
		String chip = iwc.getParameter(MSIConstants.PARAMETER_CHIP);
		String chipNumber = iwc.getParameter(MSIConstants.PARAMETER_CHIP_NUMBER);
		String groupName = iwc.getParameter(MSIConstants.PARAMETER_GROUP_NAME);
		String bestTime = iwc.getParameter(MSIConstants.PARAMETER_BEST_TIME);
		String goalTime = iwc.getParameter(MSIConstants.PARAMETER_GOAL_TIME);
		String agreement = iwc.getParameter(MSIConstants.PARAMETER_AGREEMENT);
		...
		String message = "";
		String refNum = "";
		boolean isAlreadyRegistered = getRaceBiz(iwc).isRegisteredInRun(Integer.parseInt(run), iwc.getCurrentLocale().equals(LocaleUtil.getIcelandicLocale()) ? ssnIS : ssn);
			...
			if (agrees) {
				...
				try {
					...
					try {
						...
						participantNumber = String.valueOf("100"/*participant.getParticipantNumber()*/);
					}
				...
				if (runGroup != null && distanceGroup != null) {
					...
					if (chip != null) {
						if (chip.equals(MSIConstants.PARAMETER_BUY_CHIP)) {
							travelURL += "_buy";
						}
						else if (chip.equals(MSIConstants.PARAMETER_RENT_CHIP)) {
							travelURL += "_rent";
						}
					}
					/*if ( (Integer.parseInt(distance) == sevenKM || Integer.parseInt(distance) == threeKM)&& ssnIS != null) {
						int age = getRaceBiz(iwc).getAgeFromPersonalID(ssnIS);
						if (age > 0 && age <= 12) {
							travelURL += "_12";
						}
					}*/
				...
				l.addParameter(MSIConstants.PARAMETER_NAME,name);
				l.addParameter(MSIConstants.GROUP_TYPE_RACE,run);
				l.addParameter(MSIConstants.GROUP_TYPE_RACE_EVENT,distance);
				l.addParameter(MSIConstants.PARAMETER_TSHIRT,tshirt);
